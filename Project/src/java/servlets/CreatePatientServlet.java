...
public class CreatePatientServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String patient_id = request.getParameter("user_id");
        ...
        try {
            PatientController.create(con, patient_id, address, current_health, ohip, phone,sin);
            request.setAttribute("insertflag", "1");
        } catch (SQLException e) {
            e.printStackTrace();
        }
        getServletContext().getRequestDispatcher("/new_patient.jsp").forward(request, response);
    }
